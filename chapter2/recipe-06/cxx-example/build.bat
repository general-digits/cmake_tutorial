...
set PATH_TO_EIGEN=%PATH_TO_SCRIPT%../../../tool/eigen/3.4.0/build

if not exist %BUILD_FOLDER_NAME% mkdir %BUILD_FOLDER_NAME%
%PATH_TO_CMAKE% -G "MinGW Makefiles" -D "CMAKE_MAKE_PROGRAM:PATH=%PATH_TO_MAKE%" "CMAKE_CXX_COMPILER:PATH=%PATH_TO_CXX_COMPILER%" "Eigen3_DIR:PATH=%PATH_TO_EIGEN%" -B %BUILD_FOLDER_NAME%  -S ../cxx-example
