...
set PATH_TO_FORTRAN_COMPILER=%PATH_TO_MINGW%/gfortran.exe
...
%PATH_TO_CMAKE% -G "MinGW Makefiles" -D "CMAKE_MAKE_PROGRAM:PATH=%PATH_TO_MAKE%" "CMAKE_FC_COMPILER=:PATH=%PATH_TO_FORTRAN_COMPILER%" -B %BUILD_FOLDER_NAME%  -S ../fortran-example
