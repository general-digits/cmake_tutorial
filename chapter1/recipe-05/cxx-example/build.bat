...
%PATH_TO_CMAKE% -G "MinGW Makefiles" -D "CMAKE_MAKE_PROGRAM:PATH=%PATH_TO_MAKE%" "CMAKE_CXX_COMPILER=:PATH=%PATH_TO_CXX_COMPILER%" ^
                -D USE_LIBRARY=ON -D MAKE_STATIC_LIBRARY=ON -D MAKE_SHARED_LIBRARY=OFF ^
                -B %BUILD_FOLDER_NAME% ^
                -S ../cxx-example
